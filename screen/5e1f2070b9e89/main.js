$('[path="5e1f2070b9e89"] #lay3, [path="5e1f2070b9e89"] #lay4, [path="5e1f2070b9e89"] #lay5').velocity({
	opacity: 0
}, {
	duration: 1
});
var delay5e1f258f76c0e = setTimeout(function () {
	$('[path="5e1f2070b9e89"] #lay5').velocity({
		opacity: 1
	}, {
		duration: 500,
		display: "block"
...
var delay5e1f258f76b92 = setTimeout(function () {
	$('[path="5e1f2070b9e89"] #lay4').velocity({
		opacity: 1
	}, {
		duration: 500,
		display: "block"
...
var delay5e1f258f76aeb = setTimeout(function () {
	$('[path="5e1f2070b9e89"] #lay3').velocity({
		opacity: 1
	}, {
		duration: 500,
		display: "block"
